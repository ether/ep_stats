![Demo](demo.gif) [![Backend Tests Status](https://github.com/ether/ep_stats/actions/workflows/test-and-release.yml/badge.svg)](https://github.com/ether/ep_stats/actions/workflows/test-and-release.yml)
