# Agent Guide — ep_stats

See pad Stats in Etherpad.
...
`ep_stats` runs inside Etherpad's test harness. From an etherpad checkout that has installed this plugin via `pnpm run plugins i --path ../ep_stats`:
...
* Server: `expressCreateServer`, `eejsBlock_exportColumn`, `eejsBlock_scripts`, `eejsBlock_mySettings`, `eejsBlock_styles`, `eejsBlock_body`, `eejsBlock_dd_view`
